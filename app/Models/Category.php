...
class Category extends MainModel
{
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'admin-list-item') {
            $query = self::select('id', 'name', 'status', 'ordering', 'parent_id', '_lft', '_rgt', 'is_home', 'created_by', 'created_at', 'updated_at', 'updated_by');
    ...
    public function getItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'get-item') {
            $result = self::select('id', 'name', 'parent_id', '_lft', '_rgt', 'status', 'ordering', 'is_home')->where('id', $params)->first();
        }
        return $result;
    }
