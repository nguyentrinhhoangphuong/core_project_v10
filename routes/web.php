...
Route::prefix('admin')
    ...
    ->group(function () {
        Route::middleware(['role:access-admin'])->group(function () {
            ...
            // ===================================== FLASH SALE ==================================
            Route::resource('flash-sales', 'FlashSaleController', ['parameters' => ['flash-sales' => 'item']]);
...
Route::group(['prefix' => '', 'as' => '', 'namespace' => 'App\\Http\\Controllers\\Frontend\\'], function () {
    ...
    Route::get('flash-sales', ['uses' => 'FlashSaleController@index', 'as' => 'frontend.home.flashsales']);
